...
<html>
   <head>
      ...
      <link rel="shortcut icon" href="{{ asset('assets2/images/favicon.png') }}" type="">
         ...
         <header class="header_section">
            <div class="container">
               <nav class="navbar navbar-expand-lg custom_nav-container ">
                  <a class="navbar-brand" href="index.html"><img width="250" src="{{ asset('assets2/images/logo.png') }}" alt="#" /></a>
                       ...
                       <li class="nav-item dropdown">
                        ...
                        <li class="nav-item dropdown">
                           ...
                           <ul class="dropdown-menu">
                              ...
                              <li><a href="testimonial.html"href="{{ route('logout') }}"
               ...
               <div class="col-md-4">
                   <div class="full">
                      <div class="logo_footer">
                        <a href="#"><img width="210" src="{{ asset('assets2/images/logo.png') }}" alt="#" /></a>
                      </div>
